...
export class PolygonController {
    ...
    findAllPolygonData(): Observable<PolygonEntity[]> {
      console.log("function called polygon"); 
      return this.polygonService.findAllPolygonData();
    }

    @Post()
    createPolygonData(@Body() polygonModel:PolygonModel): Observable<PolygonEntity> {
    // createMapData(@Body() mapModel:MapModel): Promise<Map> {
        ...
        // let queryGeo  =  "ST_SetSRID(ST_MakePoint(" + Model.lat + ", " + mapModel.lon + "), 4326)";
        // console.log("query "+queryGeo);
        
        return this.polygonService.createPolygonData(polygonModel);
    }
...
//              this.polygonService.createMapData(mapObject);
//         }
//         this.allMapData1 = [];
